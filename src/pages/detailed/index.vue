<template>
  <div class="page">
    ...
    <div class="num">
      ...
      <div class="num_con">
        <div class="jian">-</div>
        <input type="text" id="n_c" value="1" />
        <div class="add">+</div>
      </div>
    </div>
    <div class="place">
    ...
    <div class="pj">
      <div class="van_cell">
        <div class="van_cell_tit">
          <span>评价(38)</span>
        </div>
        <div class="van_cell_value">
          好评度
          <span>95%</span>
        </div>
        <i></i>
